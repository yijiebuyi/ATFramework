...
public class ViewUtils {
	 ...
	 */
	public static void injectChildAndSelf(Activity activity) {
		injectObject(activity, new ViewFinder(activity), activity.getClass()
				.getSuperclass());
		injectObject(activity, new ViewFinder(activity), activity.getClass());
	}
	...
	public static void injectChild(Object handler, View view) {
		injectObject(handler, new ViewFinder(view), handler.getClass().getSuperclass());
	}
