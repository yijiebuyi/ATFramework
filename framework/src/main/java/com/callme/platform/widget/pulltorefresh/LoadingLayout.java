...
import com.callme.platform.widget.pulltorefresh.PullToRefreshBase.Orientation;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case HORIZONTAL:
			LayoutInflater.from(context).inflate(
					R.layout.base_pull_to_refresh_header_horizontal, this);
			break;
		case VERTICAL:
		default:
			LayoutInflater.from(context).inflate(
					R.layout.base_pull_to_refresh_header_vertical, this);
			break;
		}
		...
		case PULL_FROM_END:
			...
			mRefreshingLabel = context
					.getString(R.string.pull_to_refresh_refreshing_label_end);
			mReleaseLabel = "";
			break;
		...
		default:
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableStart)) {
				...
				PullUtils.warnDeprecation("ptrDrawableTop", "ptrDrawableStart");
				imageDrawable = attrs
