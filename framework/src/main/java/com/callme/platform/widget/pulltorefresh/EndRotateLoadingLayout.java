...
public class EndRotateLoadingLayout extends LoadingLayout {
	...
	public EndRotateLoadingLayout(Context context, Mode mode,
			Orientation scrollDirection, TypedArray attrs) {
		super(context, mode, scrollDirection, attrs);
		mPullLabel = mRefreshingLabel;
		mReleaseLabel = mRefreshingLabel;
