...
public class FutureTimePicker extends LinearLayout implements OnWheelPickedListener {
    ...
    private void init() {
        ...
        mTodayStr = getResources().getString(R.string._today);
        mTomorrowStr = getResources().getString(R.string._tomorrow);
        //mAfterTomorrowStr = getResources().getString(com.wheelpicker.R.string._after_tomorrow);
        mNextYear = getResources().getString(R.string._next_year);
    ...
    public interface OnFutureDatePickListener {
        void onDatePicked(int year, int month, int day, int hour, int minute, int second);
    }
