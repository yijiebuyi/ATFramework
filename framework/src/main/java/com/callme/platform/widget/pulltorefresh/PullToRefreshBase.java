...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
    ...
    public final void setFirstLoading(boolean isFirst) {
        mIsFirstLoading = isFirst;
    }
    ...
    final void setState(State state, final boolean... params) {
        ...
        if (null != mOnPullEventListener) {
            if (mOnPullEventListener instanceof SoundPullEventListener) {
//				if (SharedPreferencesUtil.getInstance(getContext()).getBoolean(
//						SystemConsts.VOICE_SWITCH, true)) {
//					mOnPullEventListener
//							.onPullEvent(this, mState, mCurrentMode);
//				}
            } else {
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (USE_HW_LAYERS && DevicesUtil.getSystemVersionLevel() > 10) {
            /**
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LoadingLayout layout = new EndRotateLoadingLayout(context,
                Mode.PULL_FROM_END, getPullToRefreshScrollDirection(), a);
        layout.setVisibility(View.INVISIBLE);
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
            ...
            PullUtils.warnDeprecation("ptrAdapterViewBackground",
