...
import com.callme.platform.glsrender.anim.StateTransitionAnimation;
...
public class GLView {
	...
	protected void onDragIn(int x, int y) {
	...
	protected void onDragMove(int x, int y) {

	}

	protected void onDragOn(int x, int y) {

	}
	
	protected boolean onStatusBarTapScrollTop() {
		if (mComponents != null) {
	    	for (GLView child : mComponents) {
	    		if (child.onStatusBarTapScrollTop())
	    			return true;
	    	}
    	}
    	return false;
