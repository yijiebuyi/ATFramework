...
import com.callme.platform.glsrender.gl11.UploadedTexture;
...
import com.callme.platform.util.thdpool.ThreadPool.Job;
...
public class TileImageView extends GLView {
    ...
    private static TileBitmapPool sTilePool;
    ...
    public TileImageView(Context context) {
        ...
        if (TILE_SIZE == 0) {
            if (Utils.isHighResolution(context)) {
                TILE_SIZE = 510;
            } else {
                TILE_SIZE = 254;
            }
