...
public abstract class UploadedTexture extends BasicTexture {
    ...
    private int mChangedTextureFilter = GL11.GL_LINEAR;
    ...
    public void restTexureFilterFlag(int filterTyp) {
    	mChangedTextureFilter = filterTyp;
    }
        ...
        if (bitmap != null) {
            try {
                ...
                gl.glTexParameterf(GL11.GL_TEXTURE_2D,
                        GL11.GL_TEXTURE_MIN_FILTER, mChangedTextureFilter);
                gl.glTexParameterf(GL11.GL_TEXTURE_2D,
                        GL11.GL_TEXTURE_MAG_FILTER, mChangedTextureFilter);
