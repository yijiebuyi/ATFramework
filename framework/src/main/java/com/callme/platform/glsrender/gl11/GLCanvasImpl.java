...
import com.callme.platform.glsrender.core.IntArray;
...
public class GLCanvasImpl implements GLCanvas {
    ...
    private static final float GLCLEAR_VALUE = 26f / 255.0f;
    ...
    private static class GLState {
        ...
        public GLState(GL11 gl) {
            ...
            gl.glClearColor(GLCLEAR_VALUE, GLCLEAR_VALUE, GLCLEAR_VALUE, 1f);
            gl.glClearStencil(0);
    ...
    @Override
	public void loadModelViewIdentity() {
